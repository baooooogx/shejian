(function(){
    ...
    function shareWeixinFunc() {
        ...
        if (typeof window.DPApp != 'undefined') {
            // 分享PC页链接
            var jump_url ="http://hd.t.dianping.com/events/shejian-jc/mm/sz";
            var shareData = {
                ...
                "title": "舌尖2家常出镜美食抢先看，热腾腾刚出锅的团购哦！-深圳站",
	...
	function showShareDialogue(){
        ...
        var sinaShareBtn = shareBtns.eq(0),
        	...
        	sinaShareURL = "http://hd.t.dianping.com/events/shejian-jc/mm/sz",
        	qqShareURL = "http://hd.t.dianping.com/events/shejian-jc/mm/sz",
