(function(){
    ...
    function shareWeixinFunc() {
        ...
        if (typeof window.DPApp != 'undefined') {
            // 分享PC页链接
            var jump_url ="http://hd.t.dianping.com/events/shejian-jc/mm/bj";
            var shareData = {
                "image": "http://i1.dpfile.com/pc/tgzt/c029558e55a833cb5aa3e48fe896e1e0(960x250)/thumb.jpg?rd=0.49754394590854645",
                "url": jump_url+'?opentype=browser',
                "title": "舌尖2家常出镜美食抢先看，热腾腾刚出锅的团购哦！-北京站",
	...
	function showShareDialogue(){
        ...
        var sinaShareBtn = shareBtns.eq(0),
        	...
        	sinaShareContent = "舌尖2家常出镜美食抢先看，热腾腾刚出锅的团购哦！点评团抢鲜为您精心挑选节目中的美食团购，看完舌尖享受美味，根本停不下来！";
        	qqShareContent = "舌尖2家常出镜美食抢先看，热腾腾刚出锅的团购哦！点评团抢鲜为您精心挑选节目中的美食团购，看完舌尖享受美味，根本停不下来！";
        	sinaShareURL = "http://hd.t.dianping.com/events/shejian-jc/mm/bj",
        	qqShareURL = "http://hd.t.dianping.com/events/shejian-jc/mm/bj",
        	sinaSharePic = "http://hd.t.dianping.com/events/eventpic/weiboshejian4.jpg";
        	qqSharePic = "http://hd.t.dianping.com/events/eventpic/weiboshejian4.jpg";
