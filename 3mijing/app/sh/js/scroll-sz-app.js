(function(){
    ...
    function shareWeixinFunc() {
        ...
        if (typeof window.DPApp != 'undefined') {
            // 分享PC页链接
            var jump_url ="http://hd.t.dianping.com/events/shejian-mj/mm/sh";
            var shareData = {
                "image": "http://i1.dpfile.com/pc/tgzt/3679ee494cbce3b64c6363e71fe4cb6d(960x250)/thumb.jpg?rd=0.2960175813641399",
	...
	function showShareDialogue(){
        ...
        var sinaShareBtn = shareBtns.eq(0),
        	...
        	sinaShareContent = "【舌尖2·秘境】出镜美食同步购，热腾腾刚出锅的团购哦！点评团抢鲜为您精心挑选节目中的美食团购。这个周末，一起尝尝鲜活的民间美食。";
        	qqShareContent = "【舌尖2·秘境】出镜美食同步购，热腾腾刚出锅的团购哦！点评团抢鲜为您精心挑选节目中的美食团购。这个周末，一起尝尝鲜活的民间美食。";
        	sinaShareURL = "http://hd.t.dianping.com/events/shejian-mj/mm/sh",
        	qqShareURL = "http://hd.t.dianping.com/events/shejian-mj/mm/sh",
        	sinaSharePic = "http://t.dianping.com/events/eventpic/weiboshejian6.jpg";
        	qqSharePic = "http://t.dianping.com/events/eventpic/weiboshejian6.jpg";
