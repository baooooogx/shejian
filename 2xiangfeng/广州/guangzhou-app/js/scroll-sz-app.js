(function(){
    ...
    function shareWeixinFunc() {
        ...
        if (typeof window.DPApp != 'undefined') {
            // 分享PC页链接
            var jump_url ="http://hd.t.dianping.com/events/shejian-xf/mm/gz";
            var shareData = {
                "image": "http://i1.dpfile.com/pc/tgzt/c33a44f893eb3f84b66494bb22381c6e(960x250)/thumb.jpg?rd=0.6308581111952662",
                "url": jump_url+'?opentype=browser',
                "title": "点评团抢鲜献上《舌尖2相逢》出镜美食团购！-广州站",
	...
	function showShareDialogue(){
        ...
        var sinaShareBtn = shareBtns.eq(0),
        	...
        	sinaShareContent = "舌尖2相逢出镜美食抢先看，热腾腾刚出锅的团购哦！517吃货节，吃舌尖上的美食才是真吃货";
        	qqShareContent = "舌尖2相逢出镜美食抢先看，热腾腾刚出锅的团购哦！517吃货节，吃舌尖上的美食才是真吃货";
        	sinaShareURL = "http://hd.t.dianping.com/events/shejian-xf/mm/gz",
        	qqShareURL = "http://hd.t.dianping.com/events/shejian-xf/mm/gz",
        	sinaSharePic = "http://t.dianping.com/events/eventpic/weiboshejian5.jpg";
        	qqSharePic = "http://t.dianping.com/events/eventpic/weiboshejian5.jpg";
