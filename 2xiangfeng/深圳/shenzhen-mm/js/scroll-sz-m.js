(function(){
    ...
    function shareWeixinFunc() {
        ...
        if (typeof window.DPApp != 'undefined') {
            // 分享PC页链接
            var jump_url ="http://hd.t.dianping.com/events/shejian-xf/mm/sz";
            var shareData = {
                ...
                "title": "点评团抢鲜献上《舌尖2相逢》出镜美食团购！-深圳站",
	...
	function showShareDialogue(){
        ...
        var sinaShareBtn = shareBtns.eq(0),
        	...
        	sinaShareURL = "http://hd.t.dianping.com/events/shejian-xf/mm/sz",
        	qqShareURL = "http://hd.t.dianping.com/events/shejian-xf/mm/sz",
