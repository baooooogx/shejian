(function(){
    ...
    function shareWeixinFunc() {
        ...
        if (typeof window.DPApp != 'undefined') {
            // 分享PC页链接
            var jump_url ="http://hd.t.dianping.com/events/shejian-sc/mm/tj";
            var shareData = {
	...
	function showShareDialogue(){
        ...
        var sinaShareBtn = shareBtns.eq(0),
        	...
        	sinaShareURL = "http://hd.t.dianping.com/events/shejian-sc/mm/tj",
        	qqShareURL = "http://hd.t.dianping.com/events/shejian-sc/mm/tj",
